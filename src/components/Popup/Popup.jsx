    ...
    <>
      {
        orderPopup && (
        <div className="popup">
            <div className="h-screen w-screen fixed top-0 left-0 z-50 backdrop-blur-sm bg-black/50">
                <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-4 shadow-md
                bg-white rounded-md w-[300px] duration-200 dark:bg-gray-900">
                    {/* header */}
                    ...
                    <div className="mt-4">
                        ...
                        <div className='flex justify-center'>
                            <button className='bg-gradient-to-r bg-primary
